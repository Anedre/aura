            ...
            <div className="card p-4">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-3">
                  ...
                  <PriceTicker symbol={assetSymbol ?? undefined} symbolMode="plain" hover={false} price={lastPrice} deltaPct={rangeDelta ?? null} className="ml-2" updateEveryMs={3000} />
                  {current && (
                    <span className="chip tooltip">
                      {actionLabel(current.action)}
                      <span className="tooltip-panel">
                        <div className="tooltip-title">Senal del modelo</div>
                        <div className="tooltip-text">
                          El modelo indica si la idea apunta a comprar (Sube), vender (Baja) o esperar (En espera). Toma esta senal como guia y valida que encaje con tu plan y nivel de riesgo.
                        </div>
                      </span>
                    </span>
                  )}
